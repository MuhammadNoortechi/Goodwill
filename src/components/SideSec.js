...
const SideSec = () => {
  ...
  return (
    <React.Fragment>
      <section style={{marginTop:"12rem",borderTop:"1px black solid" ,background:"#e3e7f0"}} className='pb-5'>
        <div className="heading-lastdata fw-bold fs-4 ps-4 pt-3">System Admin</div>
